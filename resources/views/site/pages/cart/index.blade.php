                        ...
                        <div class="checkout-form p-3 bg-dark-1">
                            ...
                            <div class="card rounded-0 border bg-transparent mb-0 shadow-none">
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-0">{{ __('content.subtotal') }} ({{ Cart::getTotalQuantity() == 1 ? Cart::getTotalQuantity() ." ". __('content.item') : Cart::getTotalQuantity() ." ". __('content.items') }}): <span class="float-end">{{ currency(getNumbers()['total_price']) }}</span></h5>
                                    <div class="my-4"></div>
