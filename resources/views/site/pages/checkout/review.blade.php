                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="shipping-aadress">
                                                ...
                                                <p class="mb-1">
                                                    <span class="text-light">Customer:</span> {{ auth()->user()->f_name." ".auth()->user()->l_name }}
                                                </p>
                                                <p class="mb-1">
                                                    <span class="text-light">Address:</span> {{ $address['region'].", ".$address['city'].", ".$address['address']." [".$address['zip']."]" }}
                                                </p>
                                                <p class="mb-1">
                                                    <span class="text-light">Shipping:</span> {{ $address['shipping']['method'] }}
                                                </p>
                                                <p class="mb-1">
